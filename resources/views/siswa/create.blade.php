...
<div class="p-4 sm:ml-64 mt-16 flex justify-center">
    <div class="w-[900px] bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
        <h1 class="text-2xl font-semibold text-gray-800 dark:text-white mb-6">Tambah Siswa</h1>
