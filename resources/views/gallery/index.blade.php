...
<div class="p-4 sm:ml-64 mt-16">
    <div class="max-w-6xl mx-auto space-y-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-extrabold text-green-400">Kelola Gallery</h1>
            <a href="{{Route('gallery.create')}}" class="px-4 py-2 bg-green-600 text-white rounded">Tambah Gambar</a>
        </div>
